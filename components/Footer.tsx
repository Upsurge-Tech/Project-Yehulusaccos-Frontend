...
import { FaFacebook, FaInstagram, FaTiktok, FaYoutube, FaTelegram  } from 'react-icons/fa';
      ...
      <div className="mx-auto flex md:flex-row flex-col md:justify-between md:gap-x-10 space-y-8 md:space-y-0">
        ...
        <div className="md:space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/news" className="hover:text-green-600">News</Link></li>
        ...
        <div className="md:space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/contact" className="hover:text-green-600">Contact us</Link></li>
            <li><Link href="/legal-documents" className="hover:text-green-600">Legal documents</Link></li>
          </ul>
        </div>
        <div className="md:space-y-4">
          <h2 className="text-lg font-semibold">About</h2>
          <ul className="space-y-2">
            <li><Link href="/about" className="hover:text-green-600">Yehulu at a glance</Link></li>
            <li><Link href="/mission" className="hover:text-green-600">Mission, vision, and values</Link></li>
            <li><Link href="/shareholders" className="hover:text-green-600">Shareholders</Link></li>
            <li><Link href="/investor-relations" className="hover:text-green-600">Investor relations</Link></li>
          </ul>
        </div>
      </div>
    </footer>
