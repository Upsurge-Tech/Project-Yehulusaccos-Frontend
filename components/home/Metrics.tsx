...
const Metrics = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center">
      ...
      <CardFadeIn
        delay={0.3}
        className="w-full grid place-items-center grid-cols-1  sm:grid-cols-2 lg:flex lg:justify-between gap-y-5 "
      >
        <div className="flex flex-col w-full items-center gap-y-5">
          ...
          <p className="text-xl font-semibold">
            <Counter direction="up" value={3600} />+
          </p>
        ...
        <div className="flex flex-col gap-y-5 w-full items-center">
          ...
          <p className="text-xl font-semibold">
            <Counter direction="up" value={400} />
            M+
          </p>
