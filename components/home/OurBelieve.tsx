...
const OurBelieve = () => {
  ...
  const values = ["Values1", "Values2", "Values3", "Values4", "Values5", "Values6", "Values7", "Values8"]
        ...
        <div className="flex flex-col items-center lg:items-start gap-y-5 xl:gap-y-20 w-full ">
          <div className=" flex self-center flex-col w-3/4 xl:w-full">
            <Image
              ...
              alt="three circles"
            />
            <h3 className="text-lg font-semibold pt-2 xl:pt-5">{}</h3>
            <p className="text-gray-600 text-sm">{tOurBelieve('VisionParagraph')}</p>
          </div>
          <div className="flex self-center flex-col w-3/4 xl:w-full">
            <Image
              src={briefcase}
              ...
              alt="briefcase"
            />
            <h3 className="text-lg font-semibold pt-2 xl:pt-5">{tOurBelieve('Mission')}</h3>
